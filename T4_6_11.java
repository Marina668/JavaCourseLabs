...
public class T4_6_11 {

    public static void main(String[] args) {
        HealthInsuranceObligation health = new HealthInsuranceObligation(21, 5);
        CommonInsuranceObligation common = new CommonInsuranceObligation(44, 4);
